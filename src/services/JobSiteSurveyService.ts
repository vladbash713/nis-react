...
const updateJobRooms = async (jobId: number | string, params = {}, areaId: number | string): Promise<IRoomSuccess> => {
  return await HttpService.patch<IRoomSuccess>(`/v1/jobs/${jobId}/areas/${areaId}`, params);
};
