...
const adjustCreditNote = async (creditNoteId: string | number, address: string, name: string): Promise<any> => {
  return await HttpService.patch<any>(`${ENDPOINT_PREFIX_CN}/${creditNoteId}`, {
