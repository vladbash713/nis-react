...
const adjustInvoice = async (invoiceId: string | number, address: string, name: string): Promise<any> => {
  return await HttpService.patch<any>(`${ENDPOINT_PREFIX_INVOICES}/${invoiceId}`, {
