...
import {ReactComponent as WarehouseStorage} from './warehouse-storage.svg';
import {ReactComponent as ShipmentDeliver} from './shipment-deliver.svg';
import {ReactComponent as NavigationRightCircle} from './navigation-right-circle-1.svg';
import {ReactComponent as DeliveryTruck} from './delivery-truck-2.svg';
import {ReactComponent as ShipmentUpload} from './shipment-upload.svg';
import {ReactComponent as ArrowThickCircleRight} from './arrow-thick-circle-right-1.svg';
import {ReactComponent as CheckIcon} from './calendar-check-1.svg';
import {ReactComponent as CashFileIcon} from './common-file-cash.svg';
...
const ICONS_MAP: {[key: number]: any} = {
  ...
  [IconName.View]: View,
  [IconName.WarehouseStorage]: WarehouseStorage,
  [IconName.ShipmentDeliver]: ShipmentDeliver,
  [IconName.NavigationRightCircle]: NavigationRightCircle,
  [IconName.ShipmentUpload]: ShipmentUpload,
  [IconName.DeliveryTruck]: DeliveryTruck,
  [IconName.ToastClose]: Remove,
  [IconName.ArrowThickCircleRight]: ArrowThickCircleRight,
  [IconName.CheckIcon]: CheckIcon,
  [IconName.CashFileIcon]: CashFileIcon
};
...
class Icon extends React.PureComponent<IProps> {
  ...
  public render() {
    ...
    if (this.props.name === IconName.ToastClose) {
      return <IconComponent width={this.props.size} height={this.props.size} />;
    } else {
