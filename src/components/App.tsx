...
import InventoryReportPage from 'src/components/AppLayout/WarehousingLayout/Pages/InventoryItems/InventoryReportPage';
...
class App extends React.Component<IProps, IState> {
  ...
  public render() {
    ...
    return (
      <BrowserRouter>
        <Switch>
          <Route exact path="/operations/warehousing/inventory/:id/report" component={InventoryReportPage} />
