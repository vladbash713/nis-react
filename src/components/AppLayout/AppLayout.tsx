...
import InventoryItemsPage from 'src/components/AppLayout/WarehousingLayout/Pages/InventoryItems/InventoryItemsPage';
import InventoryItemDetailsPage from 'src/components/AppLayout/WarehousingLayout/Pages/InventoryItems/InventoryItemDetailsPage';
import InventoryItemNotesPage from 'src/components/AppLayout/WarehousingLayout/Pages/InventoryItems/InventoryItemNotesPage';
...
import WarehousingLayout from './WarehousingLayout/WarehousingLayout';
...
class AppLayout extends React.PureComponent<IProps> {
  ...
  private getRoutes(): IRoute[] {
    ...
    const operationsItems = [
      ...
      [{path: '/operations/warehousing/inventories', name: 'Warehousing'}]
    ];
    const reportsItems = [
    ...
    return (
      <UserContext.Provider value={this.userContext}>
        <div className="h-100">
          ...
          <ToastContainer
            closeButton={<Icon name={IconName.ToastClose} size={18} />}
            newestOnTop={true}
            transition={Slide}
          />
          ...
          <Body>
            <Switch>
              ...
              <AppRoute
                path="/operations/warehousing/inventory/:id/items"
                component={InventoryItemsPage}
                permission={Permission.OPERATIONS_INVENTORY_VIEW}
              />
              ...
              <AppRoute
                ...
                component={InventoryItemNotesPage}
                permission={Permission.OPERATIONS_INVENTORY_VIEW}
              />
              <AppRoute
                path="/operations/warehousing"
