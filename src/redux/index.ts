...
import inventoriesReducer from './inventoriesDucks';
import {IInventoriesSuccess} from 'src/services/InventoriesService';
import {WarehousingReducer, IWarehousingState} from './warehousingDucks';
...
export interface IAppState {
  ...
  readonly inventories: IReturnType<IInventoriesSuccess>;
  readonly warehousing: IWarehousingState;
}
